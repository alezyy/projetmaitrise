                    ...
                    <div class="row">
                        <div class="col-md-5">
                            ...
                            <div class="strippckinfo">
                                ...
                                <br>
                                <div class="pkginfo">{{__('Price')}} : <strong>${{ number_format($package->package_price, 2) }}</strong></div>
                                <div class="pkginfo">{{__('TPS')}} : <strong>${{ number_format($package->package_price * env('TPS'), 2) }}</strong></div>
                                <div class="pkginfo">{{__('TVQ')}} : <strong>${{ number_format($package->package_price * env('TVQ'), 2)}}</strong></div>
                                <br>
