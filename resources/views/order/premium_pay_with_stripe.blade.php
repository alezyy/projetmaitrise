...
@include('includes.inner_page_title', ['page_title'=>__('Pay with Stripe for premium position')])
                    ...
                    <div class="row">
                        <div class="col-md-5">
                            ...
                            <div class="strippckinfo">
                                ...
                                <br>
                                <div class="pkginfo">{{__('Price')}} : <strong>${{ number_format($package->package_price, 3) }}</strong></div>
                                <div class="pkginfo">{{__('TPS')}} : <strong>${{ number_format($package->package_price * env('TPS'), 3 ) }}</strong></div>
                                <div class="pkginfo">{{__('TVQ')}} : <strong>${{ number_format($package->package_price * env('TVQ'),3)}}</strong></div>
                                <br>
                                <div class="pkginfo">{{__('Total')}}:
                                    <strong>
                                        ${{ number_format($package->package_price + $package->package_price * env('TPS') + $package->package_price * env('TVQ'), 3) }}
                                    </strong>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-7">
                            <div class="formpanel"> @include('flash::message')
                                ...
                                @php
                                $route = 'stripe.order.premium.package';
                                @endphp                            
