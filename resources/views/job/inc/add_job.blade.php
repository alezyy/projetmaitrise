...
<div class="row">  
    ...
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'language_id') !!}" id="language_id_div"> {!! Form::select('language_id', ['' => __('Select Language')]+$languages, null, array('class'=>'form-control', 'id'=>'language_id')) !!}
    ...
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'expiry_date') !!}">
            {!! Form::text('expiry_date', date('Y-m-d H:i:s', strtotime("+30 days")) , array('class'=>'form-control', 'id'=>'expiry_date', 'placeholder'=>__('Job expiry date'), 'autocomplete'=>'off', 'readonly' => 'true')) !!}
