<div class="section greybg">
    <div class="container"> 
        ...
        <div class="titleTop">
            ...
            <h3>{{__('PREMIUM')}} <span>{{__('Jobs')}}</span></h3>
        </div>
        <!-- title end --> 
        ...
        <ul class="jobslist row">
            ...
            @if(null !== $company && $featuredJob->end_featured_date >= date('Y-m-d H:i:s'))
            <!--Job start-->
            <li class="col-md-6">
                <div class="jobint">
                    <div class="row">
        ...
        <!--button start-->
        <div class="viewallbtn"><a href="{{route('job.list', ['is_featured'=>1])}}">{{__('View All Premium Jobs')}}</a></div>
        <!--button end--> 
    </div>
</div>