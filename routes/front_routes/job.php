...
Route::get('premium-front-job/{id}', 'Job\JobPublishController@premiumFrontJob')->name('premium.front.job');
Route::get('relaunch-front-job/{id}', 'Job\JobPublishController@relaunchFrontJob')->name('relaunch.front.job');
