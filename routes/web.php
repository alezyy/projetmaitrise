...
Route::get('company-send-new-verification', 'Company\CompaniesController@reVerification')->name('company.email-new-verification.send');
...
Route::get('/sitemap.xml/jobs', 'SitemapController@jobs');
